...
namespace McQLib.Recipes
{
    ...
    /// Charge 레시피입니다.
    /// </summary>
    public sealed class AnodeCharge : BaseConvertableRecipe
    {
        public override string GetManualString()
        {
            return "음극재 하프셀 전지를 정전류(CC), 정전류/정전압(CCCV)의 방법으로 충전합니다.\r\n" +
        ...
        public override string GetDetailString()
        {
            ...
            switch ( _sourcingType )
            {
                ...
                case SourcingType_Anode.CCCV:
                    str += $"{Current:0.00####}A, {Voltage:0.00####}V\r\n";
                    break;
        ...
        public sealed override System.Drawing.Image Icon => Properties.Resources.Icon_AnodeCharge;
        ...
        public override byte[] ToDataField( ushort stepNo, ushort endStepNo, ushort errorStepNo )
        {
            ...
            // Mode1 (1Byte) - AnodeCharge : 81
            builder.Add( ( byte )Mode1.AnodeCharge );
