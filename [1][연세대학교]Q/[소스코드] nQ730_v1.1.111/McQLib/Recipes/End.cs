...
namespace McQLib.Recipes
{
    ...
    /// End 레시피입니다.
    /// </summary>
    internal sealed class End : BaseConvertableRecipe
    {
        ...
        public sealed override System.Drawing.Image Icon => Properties.Resources.Icon_End;
        ...
        public override byte[] ToDataField( ushort stepNo, ushort endStepNo_NotUsed, ushort errorStepNo_NotUsed )
        {
            ...
            builder.Add( base.ToDataField( stepNo, endStepNo_NotUsed, errorStepNo_NotUsed ) );
